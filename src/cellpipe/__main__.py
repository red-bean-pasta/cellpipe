...
from cellpipe.main import main
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        logger.info("Commandline argument provided. Running in CLI mode...")
    ...
    logger.info("No commandline argument provided. Trying to run with UI interface...")
    ...
    win = MainWindow(arg_parser.parser, main)
    win.show()
    sys.exit(app.exec())